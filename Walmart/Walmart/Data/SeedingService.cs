...
namespace Walmart.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d1 = new Department(1, "Computers", "https://github.com/romuloreis/PI3/blob/master/seedingservice.md", 50);
            Department d2 = new Department(2, "Garden", "https://github.com/romuloreis/PI3/blob/master/seedingservice.md", 50);
            Department d3 = new Department(3, "Office", "https://github.com/romuloreis/PI3/blob/master/seedingservice.md", 50);
            Department d4 = new Department(4, "Bedroom", "https://github.com/romuloreis/PI3/blob/master/seedingservice.md", 50);
            Department d5 = new Department { Id = 5, Name = "Living", Site = "https://github.com/romuloreis/PI3/blob/master/seedingservice.md", CostumerSatisfaction = 50};
